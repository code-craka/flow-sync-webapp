  ...
  return (
    ...
    >
      <Link to={`/product/${product.id}`}>
        <div className="rounded-lg border bg-card text-card-foreground shadow-sm bg-slate-800/50 backdrop-blur-sm border-slate-700 text-white overflow-hidden group transition-all duration-300 hover:shadow-2xl hover:shadow-purple-500/20 hover:-translate-y-1 hover:border-purple-500">
  ...
  if (products.length === 0) {
    return (
      <div className="text-center text-gray-400 p-8 glass-card rounded-lg">
        ...
        <p>You can add products in your Online Store settings.</p>
      </div>
    );
  }
